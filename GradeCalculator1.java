...
public class GradeCalculator1 {
    public static void main(String[] args) {
        // Welcome message
        JOptionPane.showMessageDialog(null, "Welcome to the Grade Calculator!", "Grade Calculator", JOptionPane.INFORMATION_MESSAGE);
        ...
        if (response == JOptionPane.YES_OPTION) {
            ...
            JOptionPane.showMessageDialog(null, "Goodbye! Thanks for using the Grade Calculator.", "Goodbye", JOptionPane.INFORMATION_MESSAGE);
        }
    }
